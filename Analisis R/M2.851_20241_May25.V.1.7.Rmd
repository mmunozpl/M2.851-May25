...
knitr::opts_chunk$set(echo = FALSE, results='asis', fig.height=6, fig.width=10, warning = FALSE, message = FALSE)
library(readr)
library(dplyr)
library(ggplot2)
library(skimr)
...
-   El p-valor del test de Levene es **muy inferior a 0,05**, lo
